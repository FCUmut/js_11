...
const global = {
  ...
  api: {
    apiKey: "3f6aee75fcb14b83b975444f5a9b4513",
...
async function displayPopularShows() {
  const { results } = await fetchAPIData("tv/popular"); // if you put {} around results you can get arrays seperated as in {}s
...
async function search() {
  ...
  const urlParams = new URLSearchParams(queryString); //takes url and uses methods on it
  // console.log(queryString); // ?type=movie&search-term='X' - X is what is searched
  // console.log(urlParams.get("search-term")); // X
  // console.log(urlParams.get("type")); // movie
